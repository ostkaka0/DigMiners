GameData = function(idList) {
    ...
    this.commandTypes = typeRegisterAddByArray([], [CommandEntityMove, CommandDig, CommandPlayerDig, CommandPlayerEquipItem, CommandEntityBuild, CommandEntityHurtEntity, CommandCollisions]);
