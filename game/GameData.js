GameData = function(idList) {
    ...
    this.messagesToClient = [MessageInit, MessageCommands, MessageChunk, MessagePlayerJoin, MessagePlayerLeave, MessagePlayerInventory, MessageItemDrop, MessageEntityDestroy];
    ...
    this.componentTypes = typeRegisterAddByArray([], [PhysicsBody, Movement, Drawable, ComponentItem]);
